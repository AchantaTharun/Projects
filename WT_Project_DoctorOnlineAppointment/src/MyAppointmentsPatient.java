...
/**
 * Servlet implementation class MyAppointmentsPatient
 */
@WebServlet("/MyAppointmentsPatient")
public class MyAppointmentsPatient extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyAppointmentsPatient() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
      		Class.forName("com.mysql.jdbc.Driver");
      	      ...
      	      ResultSet rs1=stmt.executeQuery("select * from appoint where Pname='"+n1+"'");
      	    if(rs1.next()) {
      	    	 ResultSet rs=stmt.executeQuery("select * from appoint where Pname='"+n1+"'");
      	     while(rs.next()) {
